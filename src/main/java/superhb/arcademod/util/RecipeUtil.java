...
public class RecipeUtil {
	public static void registerRecipes () {
		...
		registerRecipeWithNBT(new ItemStack(ArcadeBlocks.arcadeMachine), "Game", 3, "wgw", "yyy", "wrw", 'w', Blocks.PLANKS, 'g', Blocks.GLASS, 'r', Items.REDSTONE, 'y', new ItemStack(Blocks.WOOL, 1, 4));
	}
