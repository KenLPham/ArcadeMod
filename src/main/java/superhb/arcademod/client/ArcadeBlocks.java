...
public class ArcadeBlocks {
    ...
    public static final Block prizeBox = new BlockPrize(Material.IRON).setRegistryName("prize_box");//.setCreativeTab(Arcade.tab); TODO: Rename to prize_counter

    public static final Block testArcade = new BlockTestArcade(Material.ROCK).setRegistryName("arcade_test");
}
