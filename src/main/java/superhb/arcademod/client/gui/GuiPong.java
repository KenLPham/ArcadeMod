...
public class GuiPong extends GuiArcade {
	...
	public void drawScreen (int mouseX, int mouseY, float partialTicks) {
		...
		if (inMenu) {
			...
			switch (menu) {
				case 0: // Main Menu
					this.fontRendererObj.drawString(I18n.format("game.arcademod:pong.name"), boardX + (GUI_X / 2) - (this.fontRendererObj.getStringWidth(I18n.format("game.arcademod:pong.name")) / 2), boardY + 2, Color.WHITE.getRGB());
					
					this.fontRendererObj.drawString(I18n.format("option.arcademod:start.locale"), boardX + (GUI_X / 2) - (this.fontRendererObj.getStringWidth(I18n.format("option.arcademod:start.locale")) / 2), boardY + (GUI_Y / 2) - 10, Color.WHITE.getRGB());
					this.fontRendererObj.drawString(I18n.format("option.arcademod:control.locale"), boardX + (GUI_X / 2) - (this.fontRendererObj.getStringWidth(I18n.format("option.arcademod:control.locale")) / 2), boardY + (GUI_Y / 2), Color.WHITE.getRGB());
					...
					break;
				case 1: // Start Menu
					this.fontRendererObj.drawString(I18n.format("option.arcademod:start.locale"), boardX + (GUI_X / 2) - (this.fontRendererObj.getStringWidth(I18n.format("option.arcademod:start.locale")) / 2), boardY + 2, Color.WHITE.getRGB());
					
					this.fontRendererObj.drawString(I18n.format("option.arcademod:singleplayer.name"), boardX + (GUI_X / 2) - 30, boardY + (GUI_Y / 2) - 10, Color.WHITE.getRGB());
					this.fontRendererObj.drawString(I18n.format("option.arcademod:multiplayer.name"), boardX + (GUI_X / 2) - 30, boardY + (GUI_Y / 2), Color.WHITE.getRGB());
					...
					// Back
					this.fontRendererObj.drawString("[" + KeyHandler.left.getDisplayName() + "] " + I18n.format("option.arcademod:back.name"), boardX + 2, boardY + (GUI_Y) - 23, Color.WHITE.getRGB());
					break;
				case 2: // Control Menu
					this.fontRendererObj.drawString(I18n.format("control.arcademod:mouse.pong.name"), boardX + (this.fontRendererObj.getStringWidth(I18n.format("control.arcademod:mouse.pong.name")) / 2), boardY + (GUI_Y / 2), Color.WHITE.getRGB());
					
					// Back
					this.fontRendererObj.drawString("[" + KeyHandler.left.getDisplayName() + "] " + I18n.format("option.arcademod:back.name"), boardX + 2, boardY + (GUI_Y) - 23, Color.WHITE.getRGB());
					break;
				case 3: // Multiplayer Menu
					this.fontRendererObj.drawString(I18n.format("option.arcademod:multiplayer.name"), boardX + (GUI_X / 2) - (this.fontRendererObj.getStringWidth(I18n.format("option.arcademod:multiplayer.name")) / 2), boardY + 2, Color.WHITE.getRGB());
					
					this.fontRendererObj.drawString("[" + I18n.format("text.arcademod:left_paddle.pong.name") + "]", boardX + (GUI_X / 2) - 70, boardY + (GUI_Y / 2) - 10, Color.WHITE.getRGB());
					this.fontRendererObj.drawString("[" + I18n.format("text.arcademod:right_paddle.pong.name") + "]", boardX + (GUI_X / 2) - 70, boardY + (GUI_Y / 2), Color.WHITE.getRGB());
					
					// Ready
					this.fontRendererObj.drawString("[" + KeyHandler.select.getDisplayName() + "]" + I18n.format("option.arcademod:start.locale"), boardX + 2, boardY + (GUI_Y) - 33, canStartMultiplayer ? Color.WHITE.getRGB() : Color.GRAY.getRGB());
			...
			if (endGame > 0) {
				...
				this.fontRendererObj.drawString("[" + KeyHandler.select.getDisplayName() + "]", boardX + 2, boardY + GUI_Y - 40, Color.WHITE.getRGB());
				this.fontRendererObj.drawString(I18n.format("text.arcademod:return_menu.name"), boardX + 2, boardY + GUI_Y - 30, Color.WHITE.getRGB());
			}
		}
	}
