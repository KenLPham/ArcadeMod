...
/*
    "1.1.1": "Added rotation mechanics to Tetromino",
    "1.1.3": "Added controls to Tetromino",
    "1.1.4": "Added shape movement to Tetromino",
    "1.2.0": "Added detection of full row to Tetromino",
    "1.2.1": "Added functions to remove full row and move all rows above down to Tetromino",
    "1.2.2": "Added function to check if shape is at top row to Tetromino",
    "1.2.3": "Added menus to Tetromino",
    "1.2.4": "Added menu controls to Tetromino",
    "1.2.5": "Added function to set insert coin menu position to API",
    "2.0.0": "Tetris added to Arcade Machine"
 */
public class GuiTetrominoes extends GuiArcade {
    ...
    // TODO: Press button to switch out current piece with next piece
    ...
    public void drawScreen (int mouseX, int mouseY, float partialTicks) {
        ...
        */
        ...
        if (giveNextPiece) {
            ...
            nextShape = randChar();
            rotation = 0;
            shapePos[pieceID] = new TetrominoPos();
            shapePos[pieceID].addTetrominoPos(curShape, startPos, rotation);
            curPieceID = pieceID;
            pieceID++;
            giveNextPiece = false;
        }

        drawTetromino(curShape, shapePos[curPieceID].getPosX(), 13, rotation); // Max 17
        ...
        switch (pos.getShape()) {
            case 'I':
                if (pos.getRotation() == 0 || pos.getRotation() == 2) { // 4x1
                    ...
                    else if (pos.getPosX() >= 9) return true;
                    else return true;
                }
            case 'O':
                break;
